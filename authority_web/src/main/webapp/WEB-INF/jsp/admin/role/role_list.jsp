...
<title>角色列表</title>
<script type="text/javascript" src="${ctx}/static/js/hp_list.js">
</script>
</head>
<body>
	<form>
	...
	<div>
			<button class="layui-btn bt_add" data="893px, 550px" data-url="${ctx}/role/toAddRole">新增</button>
			<button class="layui-btn layui-btn-warm bt_update" data="893px, 550px" data-url="${ctx}/role/delete">修改</button>
			<button class="layui-btn layui-btn-danger bt_delete" data-url="${ctx}/role/toUpdateRole">删除</button>
